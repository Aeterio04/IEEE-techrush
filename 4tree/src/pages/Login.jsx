...
import './Login.css'; // You should create a separate CSS file for Login
...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        if (email && password) {
            alert('Demo Login Successful!\n\nThis is a sample login form. In a real application, this would authenticate with your backend server.');
        }
    };

    const socialLogin = (provider) => {
        alert(`Demo ${provider.charAt(0).toUpperCase() + provider.slice(1)} Login\n\nThis would integrate with ${provider} OAuth in a real application.`);
    };
